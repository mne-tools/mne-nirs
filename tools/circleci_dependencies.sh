...
if [[ "$CIRCLE_JOB" == "interactive_test" ]]; then
	...
	python -m pip install --progress-bar off https://github.com/sphinx-gallery/sphinx-gallery/zipball/master https://github.com/pyvista/pyvista/zipball/master https://github.com/pyvista/pyvistaqt/zipball/main
